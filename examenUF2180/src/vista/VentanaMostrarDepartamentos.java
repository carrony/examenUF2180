...
public class VentanaMostrarDepartamentos extends JFrame {
	...
	public VentanaMostrarDepartamentos() {
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"C\u00F3digo Departamento", "C\u00F3digo Centro", "Tipo Direcci\u00F3n", "Presupuesto", "Nombre"
			}
		) {
	...
	public void setListaDepartamentos(ArrayList<Departamento> lista) {
		...
		for (Departamento dept : lista) {
			Object fila [] = {
					dept.getCodDepartamento(), dept.getCodCentro(),
					dept.getTipoDirTexto(), dept.getPresupuesto()*1000,
					dept.getNombre()
			};
			modelo.addRow(fila);
		}
